...
This article assumes familiarity with agentic AI concepts such as planning, tool use, and human-in-the-loop. If you’re new to these ideas, start with *Introduction to Agentic AI*.
...
## Two Framework Styles Banks Encounter
...
## Mortgage Underwriting Through the Lens of Agent Frameworks
...
2. LangChain / LangGraph Documentation. https://docs.langchain.com

3. Microsoft Semantic Kernel Documentation. https://learn.microsoft.com/en-us/semantic-kernel/

4. OpenAI. Function Calling and Tool Use in LLMs. https://platform.openai.com/docs/guides/function-calling

5. Jiang, Z., et al. (2025). On the Emergence of Agentic Behavior and Instability in Adaptive Systems.

6. U.S. Federal Reserve. SR 11-7: Model Risk Management (Supervisory Guidance)
