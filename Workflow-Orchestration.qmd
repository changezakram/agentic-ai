...
![Branching and Conditional Routing. The orchestration layer evaluates intermediate results and dynamically routes cases to different processing paths based on policy, risk, or customer classification. Routing decisions are explicit, auditable control points within the workflow.](images/branching-orchestration.png){#fig-branching-orchestration width="100%" fig-align="center"}
