...
This autonomy framework does not replace the orchestration maturity model above; it provides a complementary lens focused on agent capability rather than workflow governance.
