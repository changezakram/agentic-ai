...
::: {#fig-sequential-orchestration}
![Sequential Orchestration (Deterministic Handoffs). Each agent completes its task before passing structured output to the next step. Orchestration governs execution order, policy enforcement, escalation, and auditability across the workflow.](images/sequential-orchestration.png){fig-align="center" width="100%"}
:::
...
::: {#fig-parallel-orchestration}
![Parallel Orchestration with Aggregation and Escalation. The orchestration hub fans out work to specialized agents in parallel, reconciles results, enforces policy, and escalates exceptions before human decision-making.](images/parallel-orchestration.png){fig-align="center" width="100%"}
:::
