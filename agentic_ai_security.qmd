...
These frameworks use automated adversarial search to find exploits. Instead of mutating input prompts, they mutate elements of the agent's environment—web content, files, documents, and retrieved context. Each mutation is evaluated with a simple test: did the agent perform a prohibited action?
