...
Black-box red-teaming frameworks for agentic systems are emerging that test agents under strict, realistic constraints.

The attacker cannot modify the user's request or observe the agent's internal mechanics. The user query is benign. The agent's code, prompts, and orchestration logic are inaccessible. The only control available is the external environment.
