...
An agent detects a competitor’s price drop on winter coats. It adjusts pricing by region, reorders low-stock sizes, and alerts the marketing team.
:::

::: {.column width="50%"}
### 🏥 Healthcare: Early Intervention  
An agent flags early signs of sepsis in patient vitals. It alerts the care team, orders labs, preps equipment, and logs actions for compliance.
:::
...
An agent detects abnormal equipment vibration. It schedules maintenance, orders parts, adjusts production, and updates maintenance logs.
:::

::: {.column width="50%"}
### 🛒 E-commerce: Checkout Recovery  
An agent spots a user struggling at checkout. It suggests alternate payments, applies a discount, saves the cart, and notifies the UX team.
:::
