...
## Planning:     
Multi-step goals need structure. Without a plan, agents jump between tasks or skip important steps. The Planning pattern enables agents to decompose complex problems into structured sequences of actions before execution begins.
