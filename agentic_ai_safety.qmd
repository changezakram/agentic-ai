...
![**Figure:** The attacker poisons external data sources. The agent retrieves and follows the hidden instructions, producing attacker-controlled responses. Source: Adapted from Liu et al. (2023)](images/prompt_injection_.png){#fig-promp-injection fig-align="center" width="700"}
...
![**Figure:** Defense-in-Depth for Agentic AI: Mapping Attack Classes to Prevention and Containment Controls.](images/Agentic-Attack-Defence.png){#fig-Agentic-Attack-Defence fig-align="center" width="900"}
