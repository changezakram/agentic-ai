...
![**Figure: How Indirect Prompt Injection Works.** The attacker poisons external data sources. The agent retrieves and follows the hidden instructions, producing attacker-controlled responses. Source: Adapted from Liu et al. (2023)](images/prompt-injection.png){fig-align="center" width="700"}
