...
This risk is not theoretical. Research from UC Berkeley demonstrates that poisoned retrieval databases can hijack agent behavior without retraining the model.^9^ The malicious content can persist unnoticed until activation.
