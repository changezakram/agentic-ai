...
But agentic systems introduce a fourth critical dimension: **safety**.
...
In banking, safety failures look like:
- An agent approving a fraudulent loan application based on subtly manipulated data
- Miscalculating credit limits, creating systemic risk exposure
- Executing wire transfers to incorrect accounts due to prompt confusion
- Making investment recommendations that violate fiduciary obligations

Safety and security are distinct but interrelated. Security focuses on adversarial threats—attackers trying to breach, manipulate, or disrupt systems. Safety focuses on correctness under all conditions—ensuring the agent's reasoning and actions remain aligned with intended outcomes, even in scenarios the designers didn't anticipate.
