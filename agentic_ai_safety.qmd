...
**Integrity** includes more than business data accuracy. It must cover the model itself, training data, embeddings, retrieval pipelines, and tool execution paths. If any part of this chain is compromised, the agent's reasoning becomes corrupted.
